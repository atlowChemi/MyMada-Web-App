<template>
    <div class="container">
        ...
        <div>
            ...
            </h2>אנו אוספים מספר סוגים של מידע למספר שימושים על מנת לשפר ולקדם את השירות שלנו עבורך.
            <br />
        ...
        <div>
            ...
            <ul>
                ...
                <li>כדי לאפשר ניתוח מידע מהשימוש באפליקציה על מנת לקדם ולשפר את חוויית המשתמש.</li>
        ...
        <div>
            <h2>
                <b>העברת המידע</b>
            </h2>המידע של המשתמש, כולל מידע פרטי, עלול להיות מועבר — וכן להישמר — על מחשבים במדינות אחרות אשר חוקי פרטיות המידע בהם שונים מחוקי פרטיות המידע במדינת המשתמש.
            <br />
        ...
        <div>
            <h2>
                <b>אבטחת המידע</b>
            </h2>פרטיות המידע של המשתמש חשובה לנו, אך אנא זכרו כי שום שיטה להעברת מידע באינטרנט, או שמירת מידע ברשת אינה בטוחה ב100%.
            <br />
        ...
        <div>
            <h2>
                <b>ספקי שירות</b>
            </h2>אנחנו עלולים לפנות לארגונים או יחידים שהינם חיצוניים לשירות שלנו על מנת להציג את שירותינו ("ספקי שירות"), כדי שיאפשרו כלים בשירות שלנו, או על מנת לנתח נתוני שימוש באפליקציה.
            <br />
